...
var finalBlock = [
  ...
  //3/8 gap 5
  //toDo
  { location: { z: 97, y: 95, x: 66 }, blockName: "green_concrete", number: 5 },
  //1 2/3 gap 6
  { location: { z: 99, y: 95, x: 69 }, blockName: "green_concrete", number: 5 },
  //1 2/3 gap 6
  { location: { z: 99, y: 95, x: 69 }, blockName: "green_concrete", number: 6 },
  //3/2 gap 7
  { location: { z: 99, y: 95, x: 69 }, blockName: "purple_concrete", number: 6 },
  //3/2 gap 7
  { location: { z: 89, y: 95, x: 87 }, blockName: "brown_concrete", number: 7 },
  //7/12 gap 8
  { location: { z: 89, y: 95, x: 87 }, blockName: "brown_concrete", number: 7 },
  //7/12 gap 8
  { location: { z: 89, y: 95, x: 87 }, blockName: "brown_concrete", number: 8 },
  //5/24 gap 9
  { location: { z: 89, y: 95, x: 87 }, blockName: "brown_concrete", number: 8 }
  //5/24 gap 9
];
