...
export const perfectRun = [
    ...
    { location: { z: 99, y: 95, x: 55 }, direction: "west", rodLength: 8, blockName: "brown_concrete" }, //2/6
    { location: { z: 99, y: 95, x: 69 }, direction: "west", rodLength: 24, blockName: "blue_concrete" }, //1/1
    { location: { z: 99, y: 95, x: 93 }, direction: "west", rodLength: 24, blockName: "blue_concrete" }, //1/1
