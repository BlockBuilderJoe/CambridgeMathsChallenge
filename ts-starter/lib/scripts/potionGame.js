...
export function resetPotionGame() {
    return __awaiter(this, void 0, void 0, function* () {
        yield overworld.runCommandAsync("tp @e[tag=coin0] -6 90 155");
        yield overworld.runCommandAsync("tp @e[tag=coin2] -5 86 154");
        yield overworld.runCommandAsync("tp @e[tag=coin4] -6 82 155");
        yield overworld.runCommandAsync("tp @e[tag=coin6] -5 78 154");
        yield overworld.runCommandAsync("tp @e[tag=coin8] -6 75 155");
        yield overworld.runCommandAsync("tp @e[tag=coin10] -5 75 154");
