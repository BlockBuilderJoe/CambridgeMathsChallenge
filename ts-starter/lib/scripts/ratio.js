...
import { outputTotal } from "./output";
export function ratio1() {
...
function calculateRatio(ratioInput) {
    ...
    for (let i = 0; i < ratioInput.length; i++) {
        ...
        if (permutation === null || permutation === void 0 ? void 0 : permutation.matches("yellow_concrete")) {
            yellow++;
        }
        else if (permutation === null || permutation === void 0 ? void 0 : permutation.matches("pink_concrete")) {
            pink++;
        }
    }
    return { pink, yellow };
