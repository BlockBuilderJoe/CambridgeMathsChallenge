...
export function cuisenaire(event, blockName, rodLength, successMessage, direction) {
    ...
    if ((_a = event.block.permutation) === null || _a === void 0 ? void 0 : _a.matches(blockName)) {
        ...
        for (let i = 0; i < rodLength; i++) {
            ...
            if (((_c = (_b = event.block[direction](i)) === null || _b === void 0 ? void 0 : _b.permutation) === null || _c === void 0 ? void 0 : _c.matches("sandstone")) || ((_e = (_d = event.block[direction](i)) === null || _d === void 0 ? void 0 : _d.permutation) === null || _e === void 0 ? void 0 : _e.matches("white_concrete"))) {
        ...
        if (placeRods) {
            for (let i = 0; i < rodLength; i++) {
                if (["east", "west", "north", "south"].includes(direction)) {
                    (_f = event.block[direction](i)) === null || _f === void 0 ? void 0 : _f.setPermutation(BlockPermutation.resolve(blockName));
                }
                else {
            ...
            (_g = event.block) === null || _g === void 0 ? void 0 : _g.setPermutation(BlockPermutation.resolve("air"));
        }
    }
}
