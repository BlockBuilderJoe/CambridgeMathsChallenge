...
export function extendRods(event, blockName, rodLength, direction) {
    ...
    for (let i = 0; i < 10; i++) { //runs south
        if (((_b = (_a = event.block[leftDirection](i)) === null || _a === void 0 ? void 0 : _a.permutation) === null || _b === void 0 ? void 0 : _b.matches("sandstone")) || ((_d = (_c = event.block[leftDirection](i)) === null || _c === void 0 ? void 0 : _c.permutation) === null || _d === void 0 ? void 0 : _d.matches("white_concrete"))) {
            break;
        }
        else {
    ...
    for (let i = 0; i < 9; i++) { //runs north
        if (((_j = (_h = event.block[rightDirection](i)) === null || _h === void 0 ? void 0 : _h.permutation) === null || _j === void 0 ? void 0 : _j.matches("sandstone")) || ((_l = (_k = event.block[rightDirection](i)) === null || _k === void 0 ? void 0 : _k.permutation) === null || _l === void 0 ? void 0 : _l.matches("white_concrete"))) {
            break;
        }
        else {
