import { world, GameMode, system, GameRule } from "@minecraft/server";
...
world.afterEvents.playerGameModeChange.subscribe(async (event) => {
...
world.afterEvents.gameRuleChange.subscribe(async (event) => {
    setDefaultGameRules();
});
